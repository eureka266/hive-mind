...
2. Structured product update:
{
  "template_id": "product_update",
  "language": "en",
  "slots": {
    "email_subject": "What's new in your product — May 2026",
    "preheader_text": "...",
    "greeting": "May brought four major updates...",
    "sections": [
      {
        "tag": "NEW PRICING PLANS",
        "title": "Pay for what you need. Scale when you're ready.",
        "image": "https://...",
        "body": "We've redesigned our pricing...",
        "cta_text": "View plans",
        "cta_link": "https://..."
      }
    ],
    "improvements_title": "Smaller updates and fixes",
    "improvements": [
      {"title": "CSV Import & Data Export", "desc": "..."}
    ],
    "footer_link_text": "See all updates",
    "footer_link_url": "https://...",
    "closing_title": "Ready to explore what's new?",
    "closing_subtitle": "Log in to your account and see the updates firsthand.",
    "closing_cta_text": "Log In →",
    "closing_cta_link": "https://..."
  }
}
"""
...
TEMPLATES = {
    "sales": {
        "name": "Sales (售前/Free Users)",
        "file": "sales.html",
        "sender": "Sales Team",
    },
    "marketing": {
        "name": "Marketing (售后/Paid Users)",
        "file": "marketing.html",
        "sender": "Product Team",
    },
    "product_update": {
        "name": "Product Update (产品更新邮件)",
...
def assemble_structured_email(slots: dict[str, Any], language: str = "en") -> str:
    defaults = {
    ...
    template = env.get_template("product_update.html")
    return template.render(**{**defaults, **slots, "language": language})
...
def render(payload: dict[str, Any]) -> str:
    ...
    if template_id == "product_update":
        slots = payload.get("slots")
        if not isinstance(slots, dict):
            raise ValueError("product_update requires a slots object")
        return assemble_structured_email(slots, language)
